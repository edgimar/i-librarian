...
?>
<body style="padding:10px;background-color:#DFDED9">
<span class="titles">Extracted text from the file <?php print $filename; ?>:</span>
<br><br>
<div class="ui-corner-all" style="float:left;width:75%;text-align:justify;padding:10px;background-color:#ffffff">
<?php print htmlspecialchars($text); ?>
</div>
<div class="ui-corner-all" style="float:right;width:20%;text-align:left;padding:10px;background-color:#ffffff;overflow:hidden">
 <table>
