            ...
            foreach ($xml->record as $record) {
                ...
                if (!empty($bibcode) && !empty($title)) {
                    ...
                    if (!empty($affiliation))
                        print '<div class="authors">' . htmlspecialchars($affiliation) . '</div>';
        ...
        <div style="text-align: left">
            <form enctype="application/x-www-form-urlencoded" action="download_nasa.php" method="GET" id="download-form">
                <table cellspacing="0" class="threed" style="width:99%">
                    <tr>
                        <td style="border: 0;background-color: transparent" colspan="3">
                            <button id="download-search">Search</button>
                            <button id="download-reset">Reset</button>
                            <button id="download-clear">Clear</button>
                            <a href="http://adsabs.harvard.edu/abstract_service.html" target="_blank" style="float:right">NASA ADS&nbsp;</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="threed" style="width:143px">
                            Objects:
                        </td>
                        <td class="threed">
                        ...
                        <td class="threed" style="width:60px">
                    ...
                    <tr>
                        ...
                        <td class="threed">
                            <input type="text" name="nasa_searchname" size="35" style="float:left;width:50%" value="<?php print isset($_SESSION['session_download_nasa_searchname']) ? htmlspecialchars($_SESSION['session_download_nasa_searchname']) : '' ?>">
