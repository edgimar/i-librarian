...
########## display search result summaries ##############
    ...
    if (!empty($xml)) {
        ...
        if (isset($xmlxml_match[0])) $count = strip_tags ($xmlxml_match[0]);
        ...
        if ($count > 0) {
            ...
            foreach ($xml->entry as $record) {
                ...
                if (!empty($id) && !empty($title)) {
                    ...
                    print '<div class="titles brief" style="margin-right:30px';
...
########## input table ##############
                ...
                <table cellspacing="0" class="threed" style="width:99%">
                    <tr>
                        ...
                        <td style="border: 0px; background-color: transparent;text-align:right">
                            <a href="http://arxiv.org/find" target="_blank">arXiv</a>
                        </td>
  ...
  <td class="threed">
  <input type="text" name="arxiv_query' . $i . '" value="' . htmlspecialchars((isset($_SESSION['session_download_arxiv_query' . $i])) ? $_SESSION['session_download_arxiv_query' . $i] : '') . '" size="65" style="width:99%">
  </td>
  <td class="threed">
  <select name="arxiv_operator' . $i . '">
	...
	<option ' . ((isset($_SESSION['session_download_arxiv_operator' . $i]) && $_SESSION['session_download_arxiv_operator' . $i] == 'ANDNOT') ? 'selected' : '') . '>ANDNOT</option>
                    ...
                    <tr>
                        ...
                        <td class="threed">
                            <input type="text" name="arxiv_searchname" size="35" style="float:left;width:50%" value="<?php print isset($_SESSION['session_download_arxiv_searchname']) ? htmlspecialchars($_SESSION['session_download_arxiv_searchname']) : '' ?>">
